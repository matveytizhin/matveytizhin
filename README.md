...
__Обраазование:__
* МГУ им. Ломоносова факультет ВМК направление ПМИ. (Бакалавриат)

__Дополнительное образование__
* AI Masters (Направление DS). __Институт ИИ МГУ__

__Дополнительные курсы__
* ML, DL (Дъяконов)
* NLP (Vk)
* Многое другое, что мне было лень вставлять)
...
![](http://github-profile-summary-cards.vercel.app/api/cards/repos-per-language?username=matveytizhin&theme=chartreuse_dark)
